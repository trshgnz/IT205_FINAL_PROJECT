...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-6">
            <img src="{{ asset('img/hoops.jpg') }}" class="product-image" alt="Product Image">
        </div>
        <div class="col-md-6 description">
            <h1 class="text-danger">Duo Hoop Earrings</h1>
            <h2 class="text-danger">₱299.00</h2><br>
            <p>
                Discover your new go-to earrings with our DuoHoop Earrings. Pairing a cute flower design with a classic gold hoops and an enamel flower earrings, these two are the perfect addition to your summer outfits.<br>
            </p>
            <ul>
