...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-6">
            <img src="{{ asset('img/western wed.jpg') }}" class="product-image" alt="Product Image">
        </div>
        <div class="col-md-6 description">
            <h1 class="text-danger">Western Wed Necklace</h1>
            <h2 class="text-danger">₱599.00</h2><br>
            <p>
                Embrace the charm of the west with our Western Wednesday Multi-Layered Necklace. This unique piece features a combination of a delicate pearl necklace, two gold chains with a heart-shaped pendant, and a cowboy boot pendant. The standout feature is the rectangular bar pendant engraved with “11:11”, adding a touch of mystery and allure.<br>
            </p>
            <ul>
                <br><li>Made with gold-plated chains,pendants, and synthetic pearls</li>
